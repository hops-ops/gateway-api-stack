...
PACKAGE ?= gateway-api-stack
XRD_DIR := apis/gatewayapistacks
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/gatewayapistacks/standard.yaml
...
EXAMPLES := \
    examples/gatewayapistacks/minimal.yaml:: \
...
render\:%:
	@example="examples/gatewayapistacks/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
